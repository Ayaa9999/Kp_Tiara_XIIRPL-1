...
public class parkirKeluar extends javax.swing.JFrame {
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        MessageFormat header = new MessageFormat("Data Parkir Keluar");
    ...
    private void selectedData() {
        String kolom[] = {"No Tiket","Tgl Masuk","No Plat","J.Kendaraan","Jam Masuk","Jam Keluar"};
        DefaultTableModel dtm = new DefaultTableModel(null, kolom);
        String SQL = "SELECT notiket,tanggalmasuk,noplat,jeniskendaraan,jammasuk,jamkeluar FROM `parkirmasuk`";
...
//                String biaya = rs.getString(7);
                String data[] = {notiket,tanggalmasuk,noplat,jeniskendaraan,jammasuk,jamkeluar};
                dtm.addRow(data);
            }
